...
Item {
    ...
    Process {
        id: musicProc
        command: ["bash", "-c", "~/.config/quickshell/island/widgets/music_info.sh"]
    ...
    Process {
        id: eqProc
        command: ["bash", "-c", "~/.config/quickshell/island/widgets/equalizer.sh get"]
        stdout: StdioCollector {
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        Slider {
                            ...
                            onMoved: { root.userIsSeeking = true; exec(`~/.config/quickshell/island/widgets/player_control.sh seek ${value} ${root.musicData.length} "${root.musicData.playerName}"`); }
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            Slider {
                                ...
                                onMoved: exec(`~/.config/quickshell/island/widgets/equalizer.sh set_band ${index+1} ${value}`)
                ...
                RowLayout {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            MouseArea { anchors.fill: parent; onClicked: exec(`~/.config/quickshell/island/widgets/equalizer.sh preset ${modelData}`) }
                        }
                    }
                }
            }
