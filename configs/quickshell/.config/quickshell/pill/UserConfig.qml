...
QtObject {
    ...
    property string wallpaperPath: "/home/lev15/.cache/current-wallpaper"
    ...
    property var dynamicIslandLeftSwipeItems: (["time","date","volume","cava","battery","cpu","ram","workspace"])

    property var scriptPaths: ({
        button_1: "/home/lev15/.local/bin/quickshell_script/wifi-menu.sh",
        button_2: "/home/lev15/.local/bin/quickshell_script/bluetooth-menu.sh",
        button_3: "/home/lev15/.local/bin/quickshell_script/wallpaper-switch.sh",
        button_4: "/home/lev15/rofi/files/powermenu"
    })
